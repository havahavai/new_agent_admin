...
interface SeatStrategyEditorProps {
  isOpen: boolean
  onClose: () => void
...
const SeatStrategyEditor: React.FC<SeatStrategyEditorProps> = ({
  isOpen,
  onClose,
  strategy,
  passengerCount,
  ...
  const handlePreferenceChange = (value: string) => {
    ...
    // Show seat map for custom arrangement
    setShowSeatMap(value === 'custom_arrangement')
  }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          {/* Seat Map for Custom Arrangement */}
          {showSeatMap && (
            <div className="space-y-2">
...
export default SeatStrategyEditor
