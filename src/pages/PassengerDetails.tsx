...
const PassengerDetails = () => {
  ...
  const [currentPassengerData, setCurrentPassengerData] =
    useState<PassengerDetail | null>(null);
  const [uploading, setUploading] = useState(false);
  const [uploadSuccess, setUploadSuccess] = useState<string | null>(null);
  const [showInvalidDocumentDialog, setShowInvalidDocumentDialog] =
    useState(false);
  ...
  const fetchPassengerDetails = async (signal?: AbortSignal) => {
    try {
      ...
      if (passengerId) {
        ...
        console.log(
          "PassengerDetails: Starting API call to getPassengerDetailById",
          passengerIdNumber
        );
        const response = await getPassengerDetailById(
          passengerIdNumber,
          signal
        );
        ...
        if ("data" in response) {
          ...
          setPassenger({
            ...
            dateOfBirth:
              passengerData.dateOfBirth || document?.dateOfBirth || "",
            ...
            passportPlaceOfIssue: normalizePlaceOfIssue(
              passengerData.countryCode || ""
            ),
            countryOfResidence: normalizeCountryOfResidence(
              passengerData.countryOfResidence ||
          ...
          console.log(
            "PassengerDetails: API call returned error:",
  ...
  const getNationalityDisplayValue = (countryCode: string): string => {
    if (!countryCode) return "";
    const country = countries.find((c) => c.code === countryCode);
    return country ? `${country.code} - ${country.nationality}` : countryCode;
  };

  // Helper function to normalize place of issue
  const normalizePlaceOfIssue = (countryCode: string): string => {
    if (!countryCode) return "";
    ...
    if (countryCode.length === 2) {
      ...
      return matchingCountry ? matchingCountry.name : countryCode;
    }

    // If it's not a valid country code, return empty string
    return countryCode;
  };
  ...
  const handleUpdatePassenger = async () => {
    ...
    try {
      ...
      // Use country code directly for API (no conversion needed)
    ...
    try {
      ...
      if (passenger.hasDocuments) {
        ...
        if (!document?.documentId) {
          setError(
            "Document ID not found. Cannot update passport. Please refresh the page and try again."
          );
          return;
        }
  ...
  const handleDownloadDocument = async (
    ...
    try {
      ...
      const defaultFileName =
        fileName ||
        urlFileName ||
        `${passenger.documentType || "document"}_${passenger.id}.${
      ...
      try {
        ...
        const defaultFileName = `${passenger.documentType || "document"}_${
          passenger.id
        }.${documentUrl.split(".").pop() || "pdf"}`;
        ...
        setError(
          "Failed to download document. Please try viewing the document instead."
        );
      }
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-4xl">
          ...
          >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className={`mt-1 h-9 text-sm pr-10 ${
                  ...
                  <div className="border-t pt-4 mt-4">
                    <div className="mb-3">
                      <p className="text-sm text-gray-600">
                        You can update any individual field or multiple fields
                        at once. Only the fields you modify will be updated.
                      </p>
                    </div>
                    <Button
              ...
              <AccordionContent>
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          {passenger.hasDocuments
                            ? "Update your passport information below"
                            : "Add your passport information below"}
                        </p>
                      </div>
                    ...
                    {isPassportEditMode && (
                      <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                        <p className="text-sm text-blue-700">
                          <strong>Edit Mode:</strong> You can now modify the
                          passport details below. Click "Save" when done or
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange("passportPlaceOfIssue", value)
                        }
                        disabled={!isPassportEditMode}
                      >
                        <SelectTrigger
                  ...
                  <div className="border-t pt-4">
                    <h4 className="font-medium text-gray-900 border-b border-gray-200 pb-1 mb-3">
                      Passport Document
                    </h4>
                      ...
                      <div className="space-y-4">
                            ...
                            {passenger.documentUrl
                              ...
                              <div className="w-full">
                                ...
                                <div className="hidden text-center py-8 bg-gray-50 rounded">
                                  ...
                                  <p className="text-sm text-gray-500 mb-4">
                                    The document cannot be previewed in this
                                    browser
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="w-full">
                                ...
                                <div className="hidden text-center py-8 bg-gray-50 rounded">
                                  ...
                                  <p className="text-sm text-gray-500 mb-4">
                                    The image cannot be displayed in this
                                    browser
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="text-center py-8 bg-gray-50 rounded">
                                ...
                                <p className="text-sm text-gray-500 mb-4">
                                  Preview is only available for PDF and image
                                  files
                                </p>
                              </div>
                            )}
                        ...
                        <div className="flex justify-center space-x-3">
                          <Button
                            variant="outline"
                            onClick={() =>
                              handleDownloadDocument(passenger.documentUrl)
                            }
                          >
                          ...
                          <Button
                            ...
                            onClick={() =>
                              document
                                .getElementById("passport-replace")
                                ?.click()
                            }
                            disabled={uploading}
                          >
            ...
            <AccordionItem value="seat-preferences">
              ...
              <AccordionContent>
                <div className="pt-4">
                  <SimpleSeatWidget
                    checkInPreference={passenger.seatPreferences}
                  />
                </div>
              </AccordionContent>
            </AccordionItem>
      ...
      <Dialog
        open={showInvalidDocumentDialog}
        onOpenChange={setShowInvalidDocumentDialog}
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This document doesn't appear to be a valid passport. Please upload
