...
export const countries: Country[] = [
  ...
  { code: "AG", name: "Antigua and Barbuda", nationality: "Antiguan/Barbudan" },
  ...
  { code: "BA", name: "Bosnia and Herzegovina", nationality: "Bosnian/Herzegovinian" },
  ...
  { code: "KN", name: "Saint Kitts and Nevis", nationality: "Kittitian/Nevisian" },
  ...
  { code: "TT", name: "Trinidad and Tobago", nationality: "Trinidadian/Tobagonian" },
...
export const getNationalityByCountryCode = (code: string): string => {
